...
const selectItem = (event, img) => {
  ...
  if (item === -1) {
    ...
    const removedValue = img;
    const itemFiltered = sliders.filter(slider => slider !== removedValue)
    //alert('Hey, Already added !');
    sliders = itemFiltered;
  }
}
var timer;
const createSlider = (imgArray, slideType) => {
  ...
  `;
    ...
    alert("Put your expected duration Here! Duration must be Positive!")
  }
}
